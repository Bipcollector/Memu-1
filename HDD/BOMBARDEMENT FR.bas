 ...
 100 PRINT "Vous tes sur un champ de bataille avec 4 pelotons"
 ...
 160 PRINT "Le premier a dtruire les quatre pelotons ennemis"
 170 PRINT "remporte la victoire."
 180 PRINT
 190 PRINT "Bonne chance, et dites-nous ou vous voulez qu'on envoie les 
 200 PRINT
 ...
 670 PRINT "Tu m'as manque, sale rat. J'ai choisi...";M". A vous de joue
 ...
 1110 PRINT "Vous etes mort. Votre dernier avant-poste etait a ";X;". HA
